...
def main():
    ...
    if args.do_train:
        ...
        pooled_logits_list = []
        ast_loss_list = []
        data_dir = '/AIsoftwaremfq2023/code/cl_code/CodeT5/data/ast_loss_data/java-train'
            ...
            for step, batch in enumerate(bar):
                ...
                if fcn_loss_total / (step + 1) < 0.01 or cur_epoch > 10:
                    ...
                    torch.save(astLossModel.state_dict(),
                               '/AIsoftwaremfq2023/code/cl_code/CodeT5/sh/saved_models/ast_loss/final_astLossModel.bin')
                    break  # 结束当前轮次的训练
            if args.do_eval:
                pass
