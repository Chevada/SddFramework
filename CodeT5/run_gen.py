...
def eval_bleu_epoch(args, eval_data, eval_examples, model, tokenizer, split_tag, criteria):
    ...
    if args.task in ['defect']:
        ...
        if args.task == 'summarize':
            ...
            if args.task in ['concode', 'translate', 'refine','gen_class']:
                codebleu = calc_code_bleu.get_codebleu(gold_fn, output_fn, args.lang)

        result = {'em': np.mean(dev_accs) * 100, 'bleu': bleu}
        if args.task == 'concode' or args.task == 'gen_class':
...
def main():
    ...
    if args.do_test:
        ...
        args.output_dir = '/AIsoftwaremfq2023/code/cl_code/CodeT5/sh/saved_models/gen_class/codet5_base_all_lr3_bs24_src64_trg380_pat3_e40_20250217_0829'
