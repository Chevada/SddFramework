...
def main():
    ...
    if args.do_test:
        args.output_dir = '/AIsoftwaremfq2023/code/cl_code/CodeT5/sh/saved_models/concode/codet5_base_all_lr3_bs24_src320_trg150_pat3_e30_20241225_1317'
        logger.info("  " + "***** Testing *****")
        logger.info("  Batch size = %d", args.eval_batch_size)
