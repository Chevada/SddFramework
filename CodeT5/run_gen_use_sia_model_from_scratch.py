...
def main():
    ...
    logger.info(f"Successfully imported parameters from ast_predictor network {ast_loss_param_path}")
    ...
    if args.do_test:
        ...
        args.output_dir = 'saved_models/sia_gen/codet5_base_all_useeuc_lr3_bs24_src64_trg380_pat3_e40_20241125_0323'
        for criteria in ['best-ppl']:
